                ...
                <form action="{{url('upload_doctor')}}" method="post" enctype='multipart/form-data'>
                  @csrf
                    ...
                    <div class="input-group container">
                        ...
                        <input type="text" name="name" class="form-control" required="" placeholder="Ism kiriting">
                    </div>
                    <br>
                    <!-- ====================Number============================ -->
                    <div class="input-group container">
                        <span class="input-group-text">Telefon raqamini kiriting</span>
                        <input type="number" name="number" required="" class="form-control" placeholder="Telefon raqam kiriting">
                    </div>
                    ...
                    <div class="input-group container">
                        ...
                        <input type="text" name="room" required="" class="form-control" placeholder="Xona raqamini kiriting">
                    </div>
