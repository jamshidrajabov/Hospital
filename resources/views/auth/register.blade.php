...
<x-guest-layout>
    <div style="padding-bottom:20px" class="pppp">
        <x-authentication-card >
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mt-4">
                    <x-label for="password_confirmation" value="{{ __('Parolni takrorlang') }}" />
